// doughnutGame.cpp
// An implemented game child class used to play Game Of Life on Doughnut mode given an initial board.
...
DoughnutGame::DoughnutGame(int rows, int columns, string initialBoard)
{
...
void DoughnutGame::Simulation()
{
  ...
  // matrix. Since this is DOUGHNUT MODE, I wil fill these extra cells as the cells on the opposite sides of the board.
